              ...
              <div class="card bg-comman w-100">
                <div class="card-body">
                  ...
                  >
                    ...
                    <div class="db-icon">
                      <img
                        src="./assets/img/dash-icon-02.svg"
                        alt="Dashboard Icon"
                      />
                    </div>
                  </div>
              ...
              <div class="card bg-comman w-100">
                <div class="card-body">
                  ...
                  >
                    ...
                    <div class="db-icon">
                      <img
                        src="./assets/img/dash-icon-03.svg"
                        alt="Dashboard Icon"
                      />
                    </div>
                  </div>
              ...
              <div class="card bg-comman w-100">
                <div class="card-body">
                  ...
                  >
                    ...
                    <div class="db-icon">
                      <img
                        src="./assets/img/dash-icon-04.svg"
                        alt="Dashboard Icon"
                      />
                    </div>
                  </div>
              ...
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <div id="apexcharts-area" style="min-height: 365px">
                    <div
                      id="apexchartsrio56gach"
                      class="apexcharts-canvas apexchartsrio56gach apexcharts-theme-light"
                      style="width: 387px;"
                    >
                      <div class="apexcharts-tooltip apexcharts-theme-light">
                        ...
                        >
                          <span
                            ...
                            style="background-color: rgb(61, 94, 225)"
                          ></span>
                          <div
                        ...
                        >
                          <span
                            class="apexcharts-tooltip-marker"
                            style="background-color: rgb(112, 196, 207)"
                          ></span>
                          <div
                            class="apexcharts-tooltip-text"
                            style="
                  ...
                  <div class="resize-triggers">
                    <div class="expand-trigger">
                      <div style="width: 404px; height: 382px"></div>
                    </div>
              ...
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <div id="bar" style="min-height: 365px">
                    <div
                      id="apexcharts96uwl2foj"
                      class="apexcharts-canvas apexcharts96uwl2foj apexcharts-theme-light"
                      style="width: 387px;"
                    >
                      <div class="apexcharts-tooltip apexcharts-theme-light">
                        <div
                  ...
                  <div class="activity-groups">
                    <div class="activity-awards">
                      <div class="award-boxs">
                        <img src="./assets/img/award-icon-01.svg" alt="Award" />
                      </div>
                    ...
                    <div class="activity-awards">
                      <div class="award-boxs">
                        <img src="./assets/img/award-icon-02.svg" alt="Award" />
                      </div>
                      <div class="award-list-outs">
                    ...
                    <div class="activity-awards mb-0">
                      <div class="award-boxs">
                        <img src="./assets/img/award-icon-04.svg" alt="Award" />
                      </div>
                      <div class="award-list-outs">
          ...
          <div class="row">
            <div class="col-xl-6 col-sm-6 col-12">
              <div class="card flex-fill fb sm-box">
                ...
                <div class="social-boxs">
                  <img
                    src="./assets/img/social-icon-01.svg"
                    alt="Social Icon"
                  />
                </div>
              </div>
            ...
            <div class="col-xl-6 col-sm-6 col-12">
              <div class="card flex-fill twitter sm-box">
                ...
                <div class="social-boxs">
                  <img
                    src="./assets/img/social-icon-02.svg"
                    alt="Social Icon"
                  />
                </div>
              </div>
            ...
            <div class="col-xl-6 col-sm-6 col-12">
              <div class="card flex-fill insta sm-box">
                ...
                <div class="social-boxs">
                  <img
                    src="./assets/img/social-icon-03.svg"
                    alt="Social Icon"
                  />
                </div>
              </div>
            ...
            <div class="col-xl-6 col-sm-6 col-12">
              <div class="card flex-fill linkedin sm-box">
                ...
                <div class="social-boxs">
                  <img
                    src="./assets/img/social-icon-04.svg"
                    alt="Social Icon"
                  />
                </div>
              </div>
